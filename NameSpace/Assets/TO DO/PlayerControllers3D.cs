...
namespace TheAshBot.ThreeDimentional
{
    public class PlayerControllers3D
    {
        ...
        /// <param name="mouseSensitivity">This is how fast the player rotats</param>
        ...
        /// <summary>
        /// This move the player at a diferent speed when going forward than going any other direction
        /// </summary>
        /// <param name="x">This is the movement on the x axis<</param>
        /// <param name="z">This is the movement on the z axis</param>
        /// <param name="thisObject">This is the object that is being moved</param>
        ...
        {
            Vector3 moveX = thisObject.transform.right * x * strafeSpeed;
            Vector3 moveZ = Vector3.zero;
            if (z >= 0.1)
            {
                moveZ = thisObject.transform.forward * z * speed;
            }
            else if (z <= -0.1)
            {
                moveZ = thisObject.transform.forward * z * strafeSpeed;
            }
        ...
        /// <summary>
        /// This has every thisng for 1st person charcter controller movemnt
        /// </summary>
        /// <param name="x">This is the movement on the x axis</param>
        /// <param name="z">This is the movement on the z axis</param>
        /// <param name="thisObject">This is the object that is being moved</param>
        ...
        /// <param name="isSprinting">This is the trigger that makec the player sprint</param>
        ...
        /// <param name="controller">This is the Character Controller</param>
        /// <param name="speed">This is the speed that the player moves forward</param>
        /// <param name="camera">The camera that determens the forward direction</param>
        /// <param name="turnSmoothTime">This is the time it takes to move 360 Degrese</param>
        ...
        /// <summary>
        /// This has every thisng for 3rd person charcter controller movemnt
        /// </summary>
        /// <param name="x">This is the movement on the x axis</param>
        /// <param name="z">This is the movement on the z axis</param>
        /// <param name="thisObject">This is the object that is being moved</param>
            ...
            float strafeSpeed, Transform camera, float turnSmoothTime, float jumpHeight, float gravity, bool isJumping, bool isSprinting)
        {
            ...
            {
                ThirdPersonCharterControllerStrafeMovement(x, z, thisObject.gameObject, controller, speed, camera, turnSmoothTime, strafeSpeed);
            }
            CharterControllerGravity(controller, gravity);
        }
        #endregion
        ...
        /// <param name="jumpHeight">This is the jump hight</param>
        ...
        #region Gravity
        /// <summary>
        /// This applys gravity to the player
        /// </summary>
        /// <param name="controller">this is the Character Controller that is used to check if the player is grounded</param>
        /// <param name="gravity">This is the gravity scale</param>
        ...
        /// <summary>
        /// This pushes a object that has a rigedbody
        ...
        /// <param name="forceMagnitude">This is the flore that is being applyed</param>
        ...
        /// </summary>
        /// <param name="controller">This is the charcter controler used to move the player</param>
        /// <param name="forward">This is the forward dirction</param>
